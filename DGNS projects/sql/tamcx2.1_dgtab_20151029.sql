...
--t_dict
delete from t_dict where version='V4.1.dgtab';
insert into t_dict (dict_kind,dict_name,dict_key,dict_info,version) values('yyt_state','莞医通业务状态','1','支付成功','V4.1.dgtab');
insert into t_dict (dict_kind,dict_name,dict_key,dict_info,version) values('yyt_state','莞医通业务状态','2','预约取消','V4.1.dgtab');
insert into t_dict (dict_kind,dict_name,dict_key,dict_info,version) values('zflx','支付类型','0','手机支付','V4.1.dgtab');
insert into t_dict (dict_kind,dict_name,dict_key,dict_info,version) values('yyt_state','莞医通订单状态','0','未付款','V4.1.dgtab');
insert into t_dict (dict_kind,dict_name,dict_key,dict_info,version) values('hyzf_ywlx','业务类型','31','翰银支付卡密充值','V4.1.dgtab');
insert into t_dict (dict_kind,dict_name,dict_key,dict_info,version) values('zflx','支付类型','1','积分支付','V4.1.dgtab');
insert into t_dict (dict_kind,dict_name,dict_key,dict_info,version) values('yxt_state','院线通业务状态','0','选座成功','V4.1.dgtab');
insert into t_dict (dict_kind,dict_name,dict_key,dict_info,version) values('yxt_state','院线通业务状态','1','出票成功','V4.1.dgtab');
insert into t_dict (dict_kind,dict_name,dict_key,dict_info,version) values('yxt_state','院线通业务状态','2','出票失败','V4.1.dgtab');
insert into t_dict (dict_kind,dict_name,dict_key,dict_info,version) values('hyzf_ywlx','业务类型','30','翰银支付话费充值','V4.1.dgtab');
insert into t_dict (dict_kind,dict_name,dict_key,dict_info,version) values('yxt_ywlx','业务类型','20','院线通电影票支付','V4.1.dgtab');
insert into t_dict (dict_kind,dict_name,dict_key,dict_info,version) values('yyt_ywlx','业务类型','10','莞医通挂号支付','V4.1.dgtab');
insert into t_dict (dict_kind,dict_name,dict_key,dict_info,version) values('yyt_ywlx','业务类型','11','莞医通诊中支付','V4.1.dgtab');
...
insert into t_report_cond (cond_id,report_id,cond_name,cond_type,is_null,order_id,cond_value,version,bak1) values('qd','hs_dgyxttable01','业务类型','2','0',4,'yxt_ywlx','V4.1.dgtab','1');
...
insert into t_report_cond (cond_id,report_id,cond_name,cond_type,is_null,order_id,cond_value,version,bak1) values('q6','hs_dgyyttable02','业务类型','2','0',6,'yxt_ywlx','V4.1.dgtab','1');
...
insert into t_report_cond (cond_id,report_id,cond_name,cond_type,is_null,order_id,cond_value,version,bak1) values('qf','hs_dgyxttable02','业务类型','2','0',6,'yxt_ywlx','V4.1.dgtab','1');
