...
create unique index index_ywty_acctinfo_1 on ywty_acctinfo( CPDM, YWBH，DWBH );
alter table ywty_acctinfo add constraint ywty_acctinfo_key primary key(CPDM, YWBH，DWBH);
comment on table  ywty_acctinfo  is 'ywty_acctinfo' ;
comment on column ywty_acctinfo.CPDM is '产品代码' ;
