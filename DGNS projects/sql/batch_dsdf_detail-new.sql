...
(
   ...
   JYJE                 DECIMAL(15,2),   
   SJJE                 DECIMAL(15,2),   
   PTLSH                VARCHAR(32) NOT NULL,    
   YWLSH                VARCHAR(32) NOT NULL,    
   JYLSH                VARCHAR(32) NOT NULL,    
   PTDM                 VARCHAR(32),   
   BFKKBZ               CHAR(1),   
   BZ                   CHAR(8),   
   GYLSH                VARCHAR(32),   
...
CREATE INDEX BATCH_DSDF_DETAIL_IDX1 IN AGENT_INDEX ON BATCH_DSDF_DETAIL(ZJPCH,WBXH);
CREATE INDEX BATCH_DSDF_DETAIL_IDX2 IN AGENT_INDEX ON BATCH_DSDF_DETAIL(WBPCH,WBXH);
CREATE INDEX BATCH_DSDF_DETAIL_IDX3 IN AGENT_INDEX ON BATCH_DSDF_DETAIL(PKRQ,YWBH);
CREATE INDEX BATCH_DSDF_DETAIL_IDX4 IN AGENT_INDEX ON BATCH_DSDF_DETAIL(PKRQ,PTPCH,SHZT,CLZT);
CREATE INDEX BATCH_DSDF_DETAIL_IDX5 IN AGENT_INDEX ON BATCH_DSDF_DETAIL(YHZH,ZWRQ,ZYDM);
...
comment on column BATCH_DSDF_DETAIL.REMARK1 is '备用1';
comment on column BATCH_DSDF_DETAIL.REMARK2 is '备用2';
