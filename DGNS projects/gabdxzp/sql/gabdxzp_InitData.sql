...
values ('K_DXZP_SYNFLAG','0','040','/gabdxzp/hxsynflg','1','同步标志','0','00000','admin','20151019090000');
Insert into APP_CSKZ (csjz,cslx,cstj,jdm,jdz,remark,jzlx,whjg,whgy,whsj) 
...
values ('100301', '交易明细查询', '945106', '交易明细查询', '1', '0', '1', '100302', '', '');

insert into gab_dxzp_bwpz (JYLXBM, JYLXMC, JYDM, JYMC, XXLZMS, LDHZDBZ, FKQZDBZ, BY1, BY2, BY3)
values ('100303', '主体查询', '945107', '主体查询', '1', '0', '1', '100304', '', '');

insert into gab_dxzp_bwpz (JYLXBM, JYLXMC, JYDM, JYMC, XXLZMS, LDHZDBZ, FKQZDBZ, BY1, BY2, BY3)
values ('100305', '动态查询', '945108', '动态查询', '1', '0', '1', '100306', '', '');

insert into gab_dxzp_bwpz (JYLXBM, JYLXMC, JYDM, JYMC, XXLZMS, LDHZDBZ, FKQZDBZ, BY1, BY2, BY3)
values ('100307', '动态解除查询', '945109', '动态解除查询', '1', '0', '1', '100308', '', '');

insert into gab_dxzp_bwpz (JYLXBM, JYLXMC, JYDM, JYMC, XXLZMS, LDHZDBZ, FKQZDBZ, BY1, BY2, BY3)
values ('100309', '客户全账号查询', '945110', '客户全账号查询', '1', '0', '1', '100310', '', '');

insert into gab_dxzp_bwpz (JYLXBM, JYLXMC, JYDM, JYMC, XXLZMS, LDHZDBZ, FKQZDBZ, BY1, BY2, BY3)
values ('100201', '冻结', '945103', '冻结', '1', '1', '0', '100202', '', '');

insert into gab_dxzp_bwpz (JYLXBM, JYLXMC, JYDM, JYMC, XXLZMS, LDHZDBZ, FKQZDBZ, BY1, BY2, BY3)
values ('100203', '冻结解除', '945104', '冻结解除', '1', '1', '0', '100204', '', '');

insert into gab_dxzp_bwpz (JYLXBM, JYLXMC, JYDM, JYMC, XXLZMS, LDHZDBZ, FKQZDBZ, BY1, BY2, BY3)
values ('100205', '冻结延期', '945105', '冻结延期', '1', '1', '0', '100206', '', '');

insert into gab_dxzp_bwpz (JYLXBM, JYLXMC, JYDM, JYMC, XXLZMS, LDHZDBZ, FKQZDBZ, BY1, BY2, BY3)
values ('100101', '止付', '945100', '止付', '1', '1', '0', '100102', '', '');

insert into gab_dxzp_bwpz (JYLXBM, JYLXMC, JYDM, JYMC, XXLZMS, LDHZDBZ, FKQZDBZ, BY1, BY2, BY3)
values ('100103', '止付解除', '945101', '止付解除', '1', '1', '0', '100104', '', '');

insert into gab_dxzp_bwpz (JYLXBM, JYLXMC, JYDM, JYMC, XXLZMS, LDHZDBZ, FKQZDBZ, BY1, BY2, BY3)
values ('100105', '止付延期', '945102', '止付延期', '1', '1', '0', '100106', '', '');

insert into gab_dxzp_bwpz (JYLXBM, JYLXMC, JYDM, JYMC, XXLZMS, LDHZDBZ, FKQZDBZ, BY1, BY2, BY3)
values ('100402', '案件举报反馈', '945127', '案件举报反馈', '1', '1', '0', '100402', '', '');
