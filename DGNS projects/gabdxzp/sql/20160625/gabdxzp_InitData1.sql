...
delete from app_dwxx where dwbh = '003000710000';
insert into APP_DWXX (dwbh, dwmc, dwzjlx, dwzjhm, dwlxr, dwlxrdh, dwdz, dwemail, whjg, whgy, whsj, extfld1, extfld2, zt)
values ('003000710000', '电信诈骗客户化', null, null, null, null, null, null, '00000', 'admin', '20160225012643', null, null, '0');
commit;
...
values ('sfxtdxzp', '电信诈骗中心', '3', 'dxzp', null, '1', '10.8.208.140', '40001', 60, 60, null, null, null, null, null, null, null, null, null, null, '1', null, '/home/gapslx/file/dxzp', '/home/gapslx/file/dxzp/', '00000', 'admin', '20160225015812', 'NODEIN_GAPS2QZXT', null, '0', '2');

delete from APP_TXAQXX where ljbs='dxzpkhh';
insert into APP_TXAQXX (ljbs, ljmc, ljlx, dwbh, qdkz, txms, txdz, txdk, fscs, jscs, ljjgh, ljgyh, ljzdh, key1, key2, key3, ftpdz, ftpyh, ftpmm, ftpgzfs, ftpcsfs, ftpzdms, ftpdflj, ftpbdlj, whjg, whgy, whsj, extfld1, extfld2, txzt, qdzt)
values ('dxzpkhh', '电信诈骗客户化', '2', '003000710000', null, '1', '10.8.208.140', '40001', 60, 60, null, null, null, null, null, null, null, null, null, null, '1', null, '', '', '00000', 'admin', '20160225015812', 'NODEIN_GAPS2QZXT', null, '0', '2');
commit;
...
insert into APP_CPXX (cpdm, cpmc, yybs, zbjg, zbgy, khjl, ywrqlx, qdkzbz, jgkzcs, sxfbz, sfqybz, qyms, xyxljz, kkfs, jzsx, dzms, zjyyh, zjzyyh, lsblts, pdblts, jyfs, rzms, whjg, whgy, whsj, extfld1, extfld2, cpzt)
values ('sfxt_dxzp', '司法系统电信诈骗', '040', '00000', 'admin', null, '2', '1', '0', '1', '0', null, null, '1', '0', '2', null, null, 0, 0, '1', '1', '00000', 'tuql', '20160225133840', null, null, '0');

delete from APP_CPXX where cpdm='0030007';
insert into APP_CPXX (cpdm, cpmc, yybs, zbjg, zbgy, khjl, ywrqlx, qdkzbz, jgkzcs, sxfbz, sfqybz, qyms, xyxljz, kkfs, jzsx, dzms, zjyyh, zjzyyh, lsblts, pdblts, jyfs, rzms, whjg, whgy, whsj, extfld1, extfld2, cpzt)
values ('0030007', '电信诈骗客户化', '040', '00000', 'admin', null, '2', '1', '0', '1', '0', null, null, '1', '0', '2', null, null, 0, 0, '1', '1', '00000', 'tuql', '20160225133840', null, null, '0');
...
delete from APP_DWCPXY where dwbh='003000710000';
insert into APP_DWCPXY (dwbh, cpdm, ywbh, ywmc, xybh, yhdm, ljbs, zhlx, sfbz, dszh, dszhmc, dfzh, dfzhmc, khjl, lxr, email, lxdh, hyksrq, hyjsrq, bljg, blgy, blrq, zhzded, whjg, whgy, whsj, extfld1, extfld2, qyzt)
values ('003000710000', '0030007', '003000710000', '电信诈骗客户化', '003000710000', null, 'dxzpkhh', null, '', '', '', null, null, null, null, null, null, null, null, null, null, null, 0, '00000', 'tuql', '20160225135320', null, null, '0');

commit;

-- 前置参数信息 --
delete from APP_CSKZ where cstj='040';
Insert into APP_CSKZ (csjz,cslx,cstj,jdm,jdz,remark,jzlx,whjg,whgy,whsj) 
values ('K_DXZP_SYNFLAG','0','040','/gabdxzp/hxsynflg','1','同步标志0-同步 1-异步','0','00000','admin','20151019090000');
Insert into APP_CSKZ (csjz,cslx,cstj,jdm,jdz,remark,jzlx,whjg,whgy,whsj) 
...
-- 客户化新加 --
Insert into APP_CSKZ (csjz,cslx,cstj,jdm,jdz,remark,jzlx,whjg,whgy,whsj) 
values ('K_DXZP_AUTORES','0','040','/gabdxzp/autores','1','回复方式设置0-自动,1-人工','0','00000','admin','20151019090000');
...
delete from gab_dxzp_bwpz where JYLXBM in('100301','100303','100305','100307','100309','100201','100203','100205','100101','100103','100105','100402');
insert into gab_dxzp_bwpz (JYLXBM, JYLXMC, JYDM, JYMC, XXLZMS, LDHZDBZ, FKQZDBZ, BY1, BY2, BY3)
values ('100301', '交易明细查询', '945106', '交易明细查询', '0', '0', '1', '100302', '', '');

insert into gab_dxzp_bwpz (JYLXBM, JYLXMC, JYDM, JYMC, XXLZMS, LDHZDBZ, FKQZDBZ, BY1, BY2, BY3)
values ('100303', '主体查询', '945107', '主体查询', '0', '0', '1', '100304', '', '');

insert into gab_dxzp_bwpz (JYLXBM, JYLXMC, JYDM, JYMC, XXLZMS, LDHZDBZ, FKQZDBZ, BY1, BY2, BY3)
values ('100305', '动态查询', '945108', '动态查询', '0', '0', '0', '100306', '', '');

insert into gab_dxzp_bwpz (JYLXBM, JYLXMC, JYDM, JYMC, XXLZMS, LDHZDBZ, FKQZDBZ, BY1, BY2, BY3)
values ('100307', '动态解除查询', '945109', '动态解除查询', '0', '0', '1', '100308', '', '');

insert into gab_dxzp_bwpz (JYLXBM, JYLXMC, JYDM, JYMC, XXLZMS, LDHZDBZ, FKQZDBZ, BY1, BY2, BY3)
values ('100309', '客户全账号查询', '945110', '客户全账号查询', '0', '0', '1', '100310', '', '');

insert into gab_dxzp_bwpz (JYLXBM, JYLXMC, JYDM, JYMC, XXLZMS, LDHZDBZ, FKQZDBZ, BY1, BY2, BY3)
values ('100201', '冻结', '945103', '冻结', '0', '0', '1', '100202', '', '');

insert into gab_dxzp_bwpz (JYLXBM, JYLXMC, JYDM, JYMC, XXLZMS, LDHZDBZ, FKQZDBZ, BY1, BY2, BY3)
values ('100203', '冻结解除', '945104', '冻结解除', '0', '0', '1', '100204', '', '');

insert into gab_dxzp_bwpz (JYLXBM, JYLXMC, JYDM, JYMC, XXLZMS, LDHZDBZ, FKQZDBZ, BY1, BY2, BY3)
values ('100205', '冻结延期', '945105', '冻结延期', '0', '0', '1', '100206', '', '');

insert into gab_dxzp_bwpz (JYLXBM, JYLXMC, JYDM, JYMC, XXLZMS, LDHZDBZ, FKQZDBZ, BY1, BY2, BY3)
values ('100101', '止付', '945100', '止付', '0', '0', '1', '100102', '', '');

insert into gab_dxzp_bwpz (JYLXBM, JYLXMC, JYDM, JYMC, XXLZMS, LDHZDBZ, FKQZDBZ, BY1, BY2, BY3)
values ('100103', '止付解除', '945101', '止付解除', '0', '0', '1', '100104', '', '');

insert into gab_dxzp_bwpz (JYLXBM, JYLXMC, JYDM, JYMC, XXLZMS, LDHZDBZ, FKQZDBZ, BY1, BY2, BY3)
values ('100105', '止付延期', '945102', '止付延期', '0', '0', '1', '100106', '', '');

insert into gab_dxzp_bwpz (JYLXBM, JYLXMC, JYDM, JYMC, XXLZMS, LDHZDBZ, FKQZDBZ, BY1, BY2, BY3)
values ('100402', '案件举报反馈', '945127', '案件举报反馈', '0', '0', '1', '100402', '', '');
