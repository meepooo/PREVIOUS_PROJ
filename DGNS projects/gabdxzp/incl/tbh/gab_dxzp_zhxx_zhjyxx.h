...
修改时间:
************************************************************************
表    名:gab_dxzp_zhxx_zhjyxx (电信诈骗卡介质_账户基本信息_账户信息_交易明细)
说    明:
************************************************************************
修改记录:
修改日期:
...
typedef struct TDB_GAB_DXZP_ZHXX_ZHJYXX
{
	...
	char   jydfmc[60+1];  /*交易对方名称*/
		/*交易对方名称*/
	char   jydfzh[50+1];  /*交易对方账号*/
		/*交易对方账号*/
	char   jydfzjhm[30+1];  /*交易对方证件号码*/
		/*交易对方证件号码*/
	char   jydfzhkhh[90+1];  /*交易对方账号开户行*/
		/*交易对方账号开户行*/
