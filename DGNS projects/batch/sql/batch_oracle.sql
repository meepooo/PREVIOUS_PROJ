drop table BATCH_AUDITINGCFG cascade constraints;

drop table BATCH_AUDITINGFUNC cascade constraints;

drop table BATCH_AUDITINGPARA cascade constraints;

drop table BATCH_AUDITINGREG cascade constraints;

drop table BATCH_CLI_PARA cascade constraints;

drop table BATCH_CLI_USER cascade constraints;

drop table BATCH_ENCRYPTREG cascade constraints;

drop table BATCH_FILECOLUMN cascade constraints;

drop index K_BAT_FILEMAP_1;
drop index K_BAT_FILEMAP_2;
drop index K_BAT_FILEMAP_3;
drop index K_BAT_FILEMAP_4;
drop table BATCH_FILEMAP cascade constraints;

drop table BATCH_FILESORT cascade constraints;
...
drop table BATCH_MAPINFO cascade constraints;

drop table BATCH_MAPRESP cascade constraints;
...
drop table BATCH_STEPATTRIB cascade constraints;
...
(
   FUNCID               VARCHAR2(32)                    not null,
   PARASN               INTEGER                         not null,
   PARAVALUE            VARCHAR2(60),
   SNOTE                VARCHAR2(32),
...
(
   ENCRYPTID            VARCHAR2(50)                    not null,
   ENCRYPTMODE          VARCHAR2(1),
   ENCRYPTTYPE          VARCHAR2(1),
   SVRNAME              VARCHAR2(128),
   FILENAME             VARCHAR2(128),
   FUNCNAME             VARCHAR2(128),
   ENCRYNOTE            VARCHAR2(120),
   WHJG                 VARCHAR2(16),
   WHGY                 VARCHAR2(16),
   WHSJ                 VARCHAR2(14),
...
(
   ...
   HIGHERUPSN           INTEGER,
   POSITIONFLAG         VARCHAR2(1),
   CLASSPOSITION        VARCHAR2(32),
   COLUMNNO             INTEGER,
   ROWSPRTR             VARCHAR2(32),
   SPRTRATTRIB          VARCHAR2(1),
   COLUMNFLAG           VARCHAR2(1),
   COLUMNSPRTR          VARCHAR2(32),
   EXTFLD1              VARCHAR2(60),
...
(
   MAPID                VARCHAR2(32)                    not null,
   MAPTYPE              VARCHAR2(1)                     not null,
   MAPIDNOTE            VARCHAR2(40),
   YWBM                 VARCHAR2(32),
   LPWJBS               VARCHAR2(32),
   HPWJBS               VARCHAR2(32),
   TJWJBS               VARCHAR2(32),
...
(
   MAPID                VARCHAR2(32)                    not null,
   NOTE                 VARCHAR2(40),
   RESP_S               VARCHAR2(10)                    not null,
   RESP_D               VARCHAR2(20)                    not null,
   MSG_D                VARCHAR2(40),
   BZ                   VARCHAR2(1),
   WHJG                 VARCHAR2(16),
   WHGY                 VARCHAR2(16),
...
(
   ...
   STEPNAME             VARCHAR2(40),
   ATTRIBID             VARCHAR2(16)                    not null,
   ATTRIBNOTE           VARCHAR2(32),
   ATTRIBVALUE          VARCHAR2(32),
