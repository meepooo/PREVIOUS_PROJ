...
修 改 人:
************************************************************************/
#ifndef __TIPS_WTGXDJ_DRC_EH__
#define __TIPS_WTGXDJ_DRC_EH__
#ifdef DBS_ORACLE
  #include "gaps_lenmacro.eh"
#endif


typedef struct TDB_TIPS_WTGXDJ
{
    ...
    char   byzd[80+1];              /*备用字段*/
              /*备用字段，用于存储额外信息*/
    char   opbankno[12+1];              /* 开户机构 */
    char   bz[512+1];                   /* 备注 */
	char   payacct2[32+1];              /* 账号2 机构拆分时账号变动 */
	char   yzxgrq[8+1];                 /* 验证修改日期 */
}SDB_TIPS_WTGXDJ;

#define SD_DATA SDB_TIPS_WTGXDJ
#define     SD_MEMBERS\
	...
	DEFSDMEMBER(T_STRING,payacct2      ,0),\
	DEFSDMEMBER(T_STRING,yzxgrq        ,0)
    
    DECLAREFIELDS(SD_TIPS_WTGXDJ)
#undef SD_DATA
#undef SD_MEMBERS
#endif  /*end of __TIPS_WTGXDJ_DRC_EH__*/
