...
数 据 库:INFORMIX
文 件 名:tips_sszjhhls.eh
文件描述:tips_sszjhhls;结构定义数据库开发嵌C头文件
项 目 组:TIPS专用前置产品组
程 序 员:
...
修 改 人:
************************************************************************/
#ifndef __TIPS_SSZJHHLS_EH__
#define __TIPS_SSZJHHLS_EH__
#ifdef DBS_ORACLE
  #include "gaps_lenmacro.eh"
#endif


typedef struct TDB_TIPS_SSZJHHLS
{
  char   zwrq[8+1];              /*帐务日期*/
              /**/
  int    zhqzlsh;              /*综合前置流水号*/
...
#define SD_DATA SDB_TIPS_SSZJHHLS
#define	 SD_MEMBERS\
  ...
  DEFSDMEMBER(T_STRING,byzd,0)
	DECLAREFIELDS(SD_TIPS_SSZJHHLS)
#undef SD_DATA
#undef SD_MEMBERS
#endif  /*end of __TIPS_SSZJHHLS_EH__*/
