...
IRESULT ICPS_DAILYSTATUS_INSERT(HXMLTREE lXmlhandle)
{
    ...
    ICPS_GETXMLNODE_STRING(XMLNM_ICPS_DAILY_STATUS_THIRD_PRE_CHECK_STATUS, sdb_icps_daily_status.third_pre_check_status, "第三方预对账状态");
    ICPS_GETXMLNODE_STRING(XMLNM_ICPS_DAILY_STATUS_THIRD_CHECK_STATUS, sdb_icps_daily_status.third_check_status, "第三方对账状态");
    ICPS_GETXMLNODE_STRING(XMLNM_ICPS_DAILY_STATUS_SUBJECT_ACCT_ENTER_STATUS, sdb_icps_daily_status.subject_acct_enter_status, "科目入账状态");
    ICPS_GETXMLNODE_STRING(XMLNM_ICPS_DAILY_STATUS_SUBJECT_CHECK_STATUS, sdb_icps_daily_status.subject_check_status, "科目对账状态");
    ICPS_GETXMLNODE_STRING(XMLNM_ICPS_DAILY_STATUS_BUSINESS_STATUS, sdb_icps_daily_status.business_status, "业务对账状态");   
