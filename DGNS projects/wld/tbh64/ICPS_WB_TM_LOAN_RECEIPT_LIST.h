...
操作系统:
数 据 库:INFORMIX
文 件 名:ICPS_WB_TM_LOAN_RECEIPT_LIST.h
文件描述:结构定义数据库开发嵌C头文件
项 目 组:
程 序 员:[wangzh14925]
...
修改时间:
************************************************************************
表    名:ICPS_WB_TM_LOAN_RECEIPT_LIST (F_WB17.还款借据清单表)
说    明:
************************************************************************
修改记录:
修改日期:
...
修改内容:
************************************************************************/
#ifndef __ICPS_WB_TM_LOAN_RECEIPT_LIST_H__
#define __ICPS_WB_TM_LOAN_RECEIPT_LIST_H__
typedef struct TDB_ICPS_WB_TM_LOAN_RECEIPT_LIST
{
...
}ICPS_WB_TM_LOAN_RECEIPT_LIST;

#define SD_DATA  ICPS_WB_TM_LOAN_RECEIPT_LIST
#define SD_MEMBERS \ 
	...
	APP_DECLAREFIELDS(SD_ICPS_WB_TM_LOAN_RECEIPT_LIST)
#undef SD_DATA
#undef SD_MEMBERS

#endif  /*end of __ICPS_WB_TM_LOAN_RECEIPT_LIST_H__*/
