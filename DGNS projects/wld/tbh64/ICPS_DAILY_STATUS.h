...
#define SD_MEMBERS \ 
	...
	APP_DEFSDMEMBER(T_STRING,  third_pre_check_status, 0),\
	APP_DEFSDMEMBER(T_STRING,  third_check_status, 0),\
	APP_DEFSDMEMBER(T_STRING,  subject_acct_enter_status, 0),\
	APP_DEFSDMEMBER(T_STRING,  subject_check_status, 0),\
	APP_DEFSDMEMBER(T_STRING,  business_status, 0),\
