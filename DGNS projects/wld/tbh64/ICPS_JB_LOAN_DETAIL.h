...
修改时间:
************************************************************************
表    名:ICPS_JB_LOAN_DETAIL (F_JB3.放款（借据）明细文件)
说    明:
************************************************************************
修改记录:
修改日期:
...
修改内容:
************************************************************************/
#ifndef __ICPS_JB_LOAN_DETAIL_H__
#define __ICPS_JB_LOAN_DETAIL_H__
typedef struct TDB_ICPS_JB_LOAN_DETAIL
{
	...
	char   repay_acct[32+1];  /*还款帐号*/
		/*还款帐号*/
	char   loan_apply_no[64+1];  /*贷款申请单号*/
		/*贷款申请单号*/
...
#define SD_DATA  ICPS_JB_LOAN_DETAIL
#define SD_MEMBERS \ 
	...
	APP_DECLAREFIELDS(SD_ICPS_JB_LOAN_DETAIL)
#undef SD_DATA
#undef SD_MEMBERS

#endif  /*end of __ICPS_JB_LOAN_DETAIL_H__*/
