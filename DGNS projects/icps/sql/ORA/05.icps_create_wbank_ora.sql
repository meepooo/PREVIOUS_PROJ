drop table ICPS_WB_TM_ACCOUNT cascade constraints;

drop table ICPS_WB_TM_AUTH_BANK_COST cascade constraints;

drop table ICPS_WB_TM_CARD cascade constraints;

drop table ICPS_WB_TM_GL_BAL cascade constraints;

drop table ICPS_WB_TM_PLAN cascade constraints;

drop table ICPS_WB_TM_APP_MAIN cascade constraints;

drop table ICPS_WB_TM_APP_INFO cascade constraints;

drop table ICPS_WB_TM_CUSTOMER cascade constraints;

drop table ICPS_WB_TT_TXN_POST cascade constraints;

drop table ICPS_WB_TM_TXN_REJECT cascade constraints;

drop table ICPS_WB_TM_LOAN cascade constraints;

drop table ICPS_WB_TM_SCHEDULE cascade constraints;

drop table ICPS_WB_DS_ACCOUNTING_FLOW cascade constraints;

drop table ICPS_WB_TM_CUST_LIMIT_O cascade constraints;

drop table ICPS_WB_TM_AUTH_HST cascade constraints;

drop table ICPS_WB_TM_IM_INFO cascade constraints;

drop table ICPS_WB_TM_LOAN_RECEIPT_LIST cascade constraints;

drop table ICPS_WB_TM_RE_HST cascade constraints;

drop table ICPS_WB_TM_PSB_PERSONAL_INFO cascade constraints;

drop table ICPS_WB_RRS_BDM_UDF_CLEAR_TOT cascade constraints;

drop table ICPS_WB_RRS_CLEAR_DETAIL cascade constraints;

drop table ICPS_WB_RSS_OTHER_DETAIL cascade constraints;

drop table ICPS_WB_TM_COLL_REC cascade constraints;

drop table ICPS_WB_TM_LOAN_VMS cascade constraints;

drop table ICPS_WB_TM_FREE_COUPONS_INFO cascade constraints;

drop table ICPS_WB_DS_SPLIT_DIFF cascade constraints;

drop table ICPS_WB_DS_DCA_COMMISSION cascade constraints;

drop table ICPS_WB_DS_DIFF_LIST cascade constraints;

drop table ICPS_WB_DS_SUCC_LIST cascade constraints;

drop table ICPS_WB_DS_APPROVAL_FLOW cascade constraints;
...
(
   ...
   acct_type            CHAR(1),
   cust_id              VARCHAR2(20),
   cust_limit_id        VARCHAR2(20),
   product_code         CHAR(6),
   default_logical_card_no VARCHAR2(19),
   currency             CHAR(3),
   credit_limit         NUMBER(13),
   temp_limit           NUMBER(13),
   temp_limit_begin_date VARCHAR2(8),
   temp_limit_end_date  VARCHAR2(8),
   user_field1          NUMBER(5,2),
   user_field2          NUMBER(5,2),
   user_field3          NUMBER(5,2),
   curr_balance         NUMBER(15,2),
   user_field4          NUMBER(15,2),
   principal_bal        NUMBER(15,2),
   user_field5          NUMBER(15,2),
   user_field6          NUMBER(15,2),
   begin_bal            NUMBER(15,2),
   pmt_due_day_bal      NUMBER(15,2),
   user_field7          NUMBER(15,2),
   user_field8          CHAR(1),
   user_field9          NUMBER(13),
   user_field10         NUMBER(13),
   user_field11         NUMBER(13),
   user_field12         NUMBER(13),
   user_field13         NUMBER(13),
   user_field14         VARCHAR2(8),
   user_field15         VARCHAR2(8),
   user_field16         VARCHAR2(8),
   user_field17         VARCHAR2(8),
   user_field18         INTEGER,
   name                 VARCHAR2(80),
   gender               CHAR(1),
   user_field19         VARCHAR2(9),
   mobile_no            VARCHAR2(20),
   user_field20         VARCHAR2(200),
   billint_cycle        CHAR(2),
   user_field21         CHAR(1),
   user_field22         CHAR(1),
   user_field23         CHAR(1),
   user_field24         CHAR(3),
   user_field25         VARCHAR2(40),
   user_field26         VARCHAR2(40),
   user_field27         VARCHAR2(40),
   user_field28         VARCHAR2(200),
   user_field29         VARCHAR2(10),
   user_field30         VARCHAR2(80),
   user_field31         VARCHAR2(27),
   AGE_CD               CHAR(1),
   user_field32         CHAR(1),
   UNMATCH_DB           NUMBER(15,2),
   user_field33         NUMBER(15,2),
   unmatch_cr           NUMBER(15,2),
   dd_ind               CHAR(1),
   dd_bank_name         VARCHAR2(80),
   dd_bank_branch       VARCHAR2(14),
   dd_bank_acct_no      VARCHAR2(40),
   dd_bank_acct_name    VARCHAR2(80),
   last_dd_amt          NUMBER(15,2),
   last_dd_date         VARCHAR2(14),
   user_field34         CHAR(1),
   last_pmt_amt         NUMBER(15,2),
   last_pmt_date        VARCHAR2(14),
   last_stmt_date       VARCHAR2(14),
   last_pmt_due_date    VARCHAR2(14),
   last_agint_date      VARCHAR2(14),
   collect_date         VARCHAR2(14),
   collect_out_date     VARCHAR2(14),
   next_stmt_date       VARCHAR2(14),
   pmt_due_date         VARCHAR2(14),
   dd_date              VARCHAR2(14),
   grace_date           VARCHAR2(14),
   user_field35         VARCHAR2(14),
   closed_date          VARCHAR2(14),
   first_stmt_date      VARCHAR2(14),
   cancel_date          VARCHAR2(14),
   charge_off_date      VARCHAR2(14),
   user_field36         VARCHAR2(14),
   usesr_field37        NUMBER(15,2),
   usesr_field38        NUMBER(15,2),
   usesr_field39        NUMBER(15,2),
   usesr_field40        NUMBER(15,2),
   usesr_field41        NUMBER(15,2),
   usesr_field42        NUMBER(15,2),
   usesr_field43        NUMBER(15,2),
   usesr_field44        NUMBER(15,2),
   usesr_field45        NUMBER(15,2),
   usesr_field46        NUMBER(15,2),
   usesr_field47        NUMBER(15,2),
   usesr_field48        NUMBER(15,2),
   usesr_field49        INTEGER,
   ctd_retail_amt       NUMBER(15,2),
   ctd_retail_cnt       INTEGER,
   ctd_payment_amt      NUMBER(15,2),
   ctd_payment_cnt      INTEGER,
   ctd_db_adj_amt       NUMBER(15,2),
   ctd_db_adj_cnt       INTEGER,
   ctd_cr_adj_cnt       INTEGER,
   ctd_cr_adj_amt       NUMBER(15,2),
   ctd_fee_amt          NUMBER(15,2),
   ctd_fee_cnt          INTEGER,
   ctd_interest_amt     NUMBER(15,2),
   ctd_interest_cnt     INTEGER,
   user_field50         NUMBER(15,2),
   user_field51         INTEGER,
   user_field52         NUMBER(15,2),
   mtd_retail_amt       NUMBER(15,2),
   mtd_retail_cnt       INTEGER,
   user_field53         NUMBER(15,2),
   user_field54         INTEGER,
   user_field55         NUMBER(15,2),
   user_field56         INTEGER,
   ytd_retail_amt       NUMBER(15,2),
   ytd_retail_cnt       INTEGER,
   user_field57         NUMBER(15,2),
   user_field58         INTEGER,
   user_field59         NUMBER(15,2),
   user_field60         INTEGER,
   user_field61         NUMBER(15,2),
   user_field62         INTEGER,
   user_field63         NUMBER(15,2),
   user_field64         INTEGER,
   user_field65         NUMBER(15,2),
   user_field66         INTEGER,
   user_field67         NUMBER(15,2),
   user_field68         INTEGER,
   user_field69         NUMBER(15,2),
   user_field70         INTEGER,
   user_field71         NUMBER(15,2),
   user_field72         NUMBER(15,2),
   user_field73         NUMBER(15,2),
   user_field74         NUMBER(15,2),
   user_field75         VARCHAR2(8),
   user_field76         CHAR(2),
   user_field77         VARCHAR2(24),
   user_field78         VARCHAR2(24),
   user_field79         CHAR(1),
   user_field80         CHAR(1),
   user_field81         CHAR(1),
   waive_svcfee_ind     CHAR(1),
   user_field82         VARCHAR2(4),
   user_field83         VARCHAR2(4),
   user_field84         VARCHAR2(4),
   user_field85         VARCHAR2(4),
   user_field86         VARCHAR2(4),
   user_field87         VARCHAR2(4),
   user_field88         VARCHAR2(14),
   user_date2           VARCHAR2(14),
   user_field89         VARCHAR2(14),
   user_field90         VARCHAR2(14),
   user_field91         VARCHAR2(14),
   user_field92         VARCHAR2(14),
   ...
   user_field99         VARCHAR2(40),
   user_field100        VARCHAR2(40),
   user_field101        VARCHAR2(40),
   user_field102        VARCHAR2(40),
   user_field103        VARCHAR2(40),
   user_field104        VARCHAR2(40),
   user_field105        NUMBER(15,2),
   user_field106        NUMBER(15,2),
   user_field107        NUMBER(15,2),
   user_field108        NUMBER(15,2),
   user_field109        NUMBER(15,2),
   user_field110        NUMBER(15,2),
   jpa_version          INTEGER,
   mtd_payment_amt      NUMBER(15,2),
   mtd_payment_cnt      INTEGER,
   ytd_payment_amt      NUMBER(15,2),
   ytd_payment_cnt      INTEGER,
   ltd_payment_amt      NUMBER(15,2),
   ltd_payment_cnt      INTEGER,
   user_field111        CHAR(1),
   user_field112        NUMBER(15,2),
   user_field113        INTEGER,
   last_post_date       VARCHAR2(8),
   last_modified_datetime VARCHAR2(14),
   user_field114        VARCHAR2(8),
   last_sync_date       VARCHAR2(8),
   user_field115        VARCHAR2(14),
   user_field116        NUMBER(15,2),
   user_field117        VARCHAR2(16),
   bank_group_id        VARCHAR2(5),
   bank_proportion      NUMBER(5,2),
   is_check_flag        CHAR(1),
   extend_param1        VARCHAR2(100),
   extend_param2        VARCHAR2(250),
   extend_param3        VARCHAR2(40),
...
(
   busi_date            CHAR(8)              not null,
   file_order           INTEGER              not null,
   busi_serial          VARCHAR2(32),
   bank_group_id        VARCHAR2(5),
   bank_no              VARCHAR2(10),
   reg_type             VARCHAR2(50),
   reg_amt              NUMBER(15,2),
   reg_status           VARCHAR2(10),
   reg_sys_id           VARCHAR2(32),
   reg_date             VARCHAR2(14),
   reg_time             VARCHAR2(14),
   recon_code           VARCHAR2(20),
   ori_sys_id           VARCHAR2(32),
   cust_id              VARCHAR2(20),
   acct_no              VARCHAR2(20),
   acct_type            CHAR(1),
   retry                INTEGER,
   created_datetime     VARCHAR2(14),
   last_modified_datetime VARCHAR2(14),
...
(
   ...
   file_order           INTEGER              not null,
   org                  CHAR(12),
   logical_card_no      VARCHAR2(19),
   acct_no              VARCHAR2(20),
   cust_id              VARCHAR2(20),
   user_field118        VARCHAR2(15),
   product_cd           CHAR(6),
   app_no               VARCHAR2(20),
   user_field119        VARCHAR2(40),
   user_field120        CHAR(1),
   bsc_logiccard_no     VARCHAR2(19),
   user_field121        VARCHAR2(9),
   user_field122        VARCHAR2(15),
   user_field123        VARCHAR2(80),
   user_field124        VARCHAR2(19),
   user_field125        VARCHAR2(14),
   user_field126        VARCHAR2(27),
   activate_ind         CHAR(1),
   cancel_date          VARCHAR2(14),
   latest_card_no       VARCHAR2(19),
   user_field127        CHAR(1),
   user_field128        VARCHAR2(20),
   user_field129        VARCHAR2(80),
   user_field130        CHAR(1),
   user_field131        CHAR(1),
   card_expire_date     VARCHAR2(14),
   user_field132        NUMBER(5,2),
   user_field133        CHAR(1),
   user_field134        CHAR(3),
   user_field135        VARCHAR2(14),
   user_field136        VARCHAR2(14),
   user_field137        CHAR(1),
   user_field138        VARCHAR2(14),
   user_field139        CHAR(1),
   user_field140        CHAR(1),
   user_field141        CHAR(1),
   jpa_version          INTEGER,
   user_field142        VARCHAR2(14),
   user_field143        VARCHAR2(14),
   user_field144        VARCHAR2(14),
   user_field145        VARCHAR2(14),
   is_check_flag        CHAR(1),
   extend_param1        VARCHAR2(100),
   extend_param2        VARCHAR2(250),
   extend_param3        VARCHAR2(40),
...
(
   ...
   cr_amt               NUMBER(15,2),
   cr_count             INTEGER,
   last_db_bal          NUMBER(15,2),
   last_cr_bal          NUMBER(15,2),
   last_mth_db_bal      NUMBER(15,2),
   last_mth_cr_bal      NUMBER(15,2),
   last_qtr_db_bal      NUMBER(15,2),
   last_qtr_cr_bal      NUMBER(15,2),
   last_yr_db_ba        NUMBER(15,2),
   last_yr_cr_ba        NUMBER(15,2),
   jpa_version          INTEGER,
...
(
   ...
   curr_balance         NUMBER(15,2),
   begin_bal            NUMBER(15,2),
   dispute_amt          NUMBER(15,2),
   tot_due_amt          NUMBER(15,2),
   plan_add_date        VARCHAR2(14),
   paid_out_date        VARCHAR2(14),
   past_principal       NUMBER(15,2),
   past_interest        NUMBER(15,2),
   past_card_fee        NUMBER(15,2),
   past_ovrlmt_fee      NUMBER(15,2),
   past_lpc             NUMBER(15,2),
   past_nsf_fee         NUMBER(15,2),
   past_txn_fee         NUMBER(15,2),
   past_svc_fee         NUMBER(15,2),
   past_ins             NUMBER(15,2),
   past_user_fee1       NUMBER(15,2),
   past_user_fee2       NUMBER(15,2),
   past_user_fee3       NUMBER(15,2),
   past_user_fee4       NUMBER(15,2),
   past_user_fee5       NUMBER(15,2),
   past_user_fee6       NUMBER(15,2),
   CTD_PRINCIPAL        NUMBER(15,2),
   ctd_interest         NUMBER(15,2),
   ctd_card_fee         NUMBER(15,2),
   ctd_ovrlmt_fee       NUMBER(15,2),
   ctd_lpc              NUMBER(15,2),
   ctd_nsf_fee          NUMBER(15,2),
   ctd_svc_fee          NUMBER(15,2),
   ctd_txn_fee          NUMBER(15,2),
   ctd_ins              NUMBER(15,2),
   ctd_user_fee1        NUMBER(15,2),
   ctd_user_fee2        NUMBER(15,2),
   ctd_user_fee3        NUMBER(15,2),
   ctd_user_fee4        NUMBER(15,2),
   ctd_user_fee5        NUMBER(15,2),
   ctd_user_fee6        NUMBER(15,2),
   ctd_amt_db           NUMBER(15,2),
   ctd_amt_cr           NUMBER(15,2),
   ctd_nbr_db           INTEGER,
   ctd_nbr_cr           INTEGER,
   nodefbnp_int_acru    NUMBER(15,4),
   beg_defbnp_int_acru  NUMBER(15,4),
   ctd_defbnp_int_acru  NUMBER(15,4),
   user_field146        VARCHAR2(4),
   user_field147        VARCHAR2(4),
   user_field148        VARCHAR2(4),
   user_field149        VARCHAR2(4),
   user_field150        VARCHAR2(4),
   user_field151        VARCHAR2(4),
   ...
   user_field158        VARCHAR2(40),
   user_field159        VARCHAR2(40),
   user_field160        VARCHAR2(40),
   user_field161        VARCHAR2(40),
   user_field162        VARCHAR2(40),
   user_field163        VARCHAR2(40),
   user_field164        VARCHAR2(14),
   user_field165        VARCHAR2(14),
   user_field166        VARCHAR2(14),
   user_field167        VARCHAR2(14),
   user_field168        VARCHAR2(14),
   user_field169        VARCHAR2(14),
   user_field170        NUMBER(15,2),
   user_field171        NUMBER(15,2),
   user_field172        NUMBER(15,2),
   user_field173        NUMBER(15,2),
   user_field174        NUMBER(15,2),
   user_field175        NUMBER(15,2),
   jpa_version          INTEGER,
   past_penalty         NUMBER(15,2),
   ctd_penalty          NUMBER(15,2),
   past_compound        NUMBER(15,2),
   ctd_compound         NUMBER(15,2),
   penalty_acru         NUMBER(15,4),
   compound_acru        NUMBER(15,4),
   interest_rate        NUMBER(12,4),
   penalty_rate         NUMBER(12,4),
   compound_rate        NUMBER(12,4),
   use_plan_rate        CHAR(1),
   last_pmt_date        VARCHAR2(14),
   term                 INTEGER,
   calc_type            CHAR(1),
   calc_cycle           INTEGER,
   fee_rate             NUMBER(15,4),
   last_fee_date        VARCHAR2(14),
   next_fee_date        VARCHAR2(14),
   trans_serial         VARCHAR2(20),
   first_dd_date        VARCHAR2(14),
   busi_serial          VARCHAR2(32),
   sys_trans_id         VARCHAR2(32),
   user_field176        VARCHAR2(15),
   sub_terminal_type    VARCHAR2(15),
   sub_merch_id         VARCHAR2(40),
   sub_merch_name       VARCHAR2(60),
   wares_desc           VARCHAR2(60),
   last_modified_datetime VARCHAR2(14),
   original_amt         NUMBER(15,4),
...
(
   ...
   app_no               VARCHAR2(20),
   user_field1          CHAR(1),
   user_field2          NUMBER(13),
   user_field3          NUMBER(13),
   acc_lmt              NUMBER(13),
   product_cd           VARCHAR2(6),
   user_field4          NUMBER(13),
   user_field5          NUMBER(13),
   user_field6          NUMBER(13),
   user_field7          NUMBER(13),
   user_field8          NUMBER(13),
   user_field9          NUMBER(13),
   user_field10         NUMBER(13),
   user_field11         NUMBER(13),
   user_field12         CHAR(1),
   user_field13         CHAR(3),
   user_field14         CHAR(1),
   user_field15         VARCHAR2(20),
   user_field16         CHAR(3),
   user_field17         INTEGER,
   user_field18         NUMBER(5,2),
   user_field19         VARCHAR2(20),
   user_field20         VARCHAR2(400),
   user_field21         VARCHAR2(1000),
   user_field22         INTEGER,
   user_field23         CHAR(1),
   user_field24         VARCHAR2(20),
   user_field25         VARCHAR2(20),
   user_field26         VARCHAR2(9),
   user_field27         VARCHAR2(20),
   user_field28         CHAR(1),
   user_field29         VARCHAR2(80),
   user_field30         VARCHAR2(20),
   user_field31         VARCHAR2(20),
   user_field32         CHAR(1),
   user_field33         VARCHAR2(9),
   user_field34         VARCHAR2(15),
   user_field35         VARCHAR2(20),
   user_field36         VARCHAR2(32),
   user_field37         CHAR(1),
   user_field38         VARCHAR2(40),
   user_field39         CHAR(1),
   user_field40         CHAR(1),
   user_field41         CHAR(1),
   user_field42         VARCHAR2(20),
   user_field43         VARCHAR2(20),
   user_field44         VARCHAR2(400),
   user_field45         VARCHAR2(40),
   user_field46         VARCHAR2(40),
   user_field47         VARCHAR2(32),
   user_field48         VARCHAR2(32),
   user_field49         VARCHAR2(32),
   user_field50         VARCHAR2(10),
   user_field51         VARCHAR2(14),
   last_modified_datetime VARCHAR2(14),
...
(
   ...
   app_no               VARCHAR2(20),
   user_field53         CHAR(1),
   user_field54         VARCHAR2(19),
   name                 VARCHAR2(80),
   emb_logo             VARCHAR2(30),
   gender               VARCHAR2(2),
   nationality          VARCHAR2(3),
   residency_country_cd CHAR(3),
   id_type              CHAR(1),
   id_no                VARCHAR2(30),
   user_field55         VARCHAR2(14),
   user_field56         VARCHAR2(200),
   birthday             VARCHAR2(14),
   user_field57         CHAR(1),
   user_field58         NUMBER(15,2),
   user_field59         CHAR(1),
   user_field60         CHAR(1),
   user_field61         VARCHAR2(3),
   user_field62         VARCHAR2(40),
   user_field63         VARCHAR2(40),
   user_field64         VARCHAR2(40),
   user_field65         CHAR(1),
   user_field66         VARCHAR2(200),
   user_field67         VARCHAR2(10),
   user_field68         VARCHAR2(20),
   user_field69         VARCHAR2(14),
   cellphone            VARCHAR2(20),
   user_field70         VARCHAR2(80),
   user_field71         VARCHAR2(40),
   user_field72         VARCHAR2(40),
   user_field73         CHAR(1),
   user_field74         VARCHAR2(2),
   user_field75         NUMBER(15,2),
   user_field76         CHAR(1),
   user_field77         VARCHAR2(20),
   user_field78         VARCHAR2(200),
   user_field79         VARCHAR2(3),
   user_field80         VARCHAR2(40),
   user_field81         VARCHAR2(40),
   user_field82         VARCHAR2(40),
   user_field83         VARCHAR2(200),
   user_field84         VARCHAR2(10),
   user_field85         VARCHAR2(20),
   user_field86         VARCHAR2(80),
   user_field87         CHAR(1),
   user_field88         CHAR(1),
   user_field89         CHAR(1),
   user_field90         NUMBER(2),
   user_field91         VARCHAR2(20),
   user_field92         CHAR(1),
   user_field93         CHAR(1),
   user_field94         VARCHAR2(14),
   user_field95         CHAR(1),
   user_field96         CHAR(1),
   user_field97         VARCHAR2(10),
   user_field98         CHAR(1),
   user_field99         CHAR(1),
   pr_of_country        CHAR(1),
   user_field100        VARCHAR2(80),
   user_field101        VARCHAR2(80),
   user_field102        VARCHAR2(80),
   user_field103        VARCHAR2(19),
   user_field104        VARCHAR2(20),
   user_field105        VARCHAR2(32),
   user_field106        VARCHAR2(40),
   user_field107        CHAR(1),
   user_field108        VARCHAR2(2),
   user_field109        VARCHAR2(40),
   user_field110        VARCHAR2(40),
   user_field111        VARCHAR2(14),
   user_field112        VARCHAR2(14),
   jpa_version          INTEGER,
   cust_no              VARCHAR2(20),
   acct_no              VARCHAR2(20),
   is_check_flag        CHAR(1),
...
(
   ...
   name                 VARCHAR2(80),
   gender               CHAR(1),
   brith_date           VARCHAR2(8) ,
   user_field177        CHAR(1),
   user_field178        VARCHAR2(20),
   nationality          CHAR(3),
   pr_of_country        CHAR(1),
   residency_country_cd CHAR(3),
   ...
   user_field182        VARCHAR2(200),
   user_field183        VARCHAR2(20),
   user_field184        CHAR(1),
   user_field185        CHAR(1),
   user_field186        VARCHAR2(14),
   user_field187        CHAR(1),
   mobile_no            VARCHAR2(20),
   user_field188        VARCHAR2(80),
   user_field189        CHAR(1),
   user_field190        INTEGER,
   language_ind         VARCHAR2(4),
   user_field191        VARCHAR2(14),
   user_field192        NUMBER(15,2),
   user_field193        VARCHAR2(20),
   user_field194        VARCHAR2(14),
   user_field195        VARCHAR2(80),
   user_field196        VARCHAR2(80),
   user_field197        CHAR(1),
   user_field198        VARCHAR2(200),
   user_field199        VARCHAR2(4),
   user_field200        VARCHAR2(4),
   user_field201        VARCHAR2(4),
   user_field202        VARCHAR2(4),
   user_field203        VARCHAR2(4),
   user_field204        VARCHAR2(4),
   user_field205        VARCHAR2(14),
   user_field206        VARCHAR2(14),
   user_field207        VARCHAR2(14),
   user_field208        VARCHAR2(14),
   user_field209        VARCHAR2(14),
   user_field210        VARCHAR2(14),
   ...
   user_field217        VARCHAR2(40),
   user_field218        VARCHAR2(40),
   user_field219        VARCHAR2(40),
   user_field220        VARCHAR2(40),
   user_field221        VARCHAR2(40),
   user_field222        VARCHAR2(40),
   user_field223        NUMBER(15,2),
   user_field224        NUMBER(15,2),
   user_field225        NUMBER(15,2),
   user_field226        NUMBER(15,2),
   user_field227        NUMBER(15,2),
   user_field228        NUMBER(15,2),
   user_field229        VARCHAR2(20),
   emb_name             VARCHAR2(26),
   jpa_version          INTEGER,
   cust_limit_id        VARCHAR2(20),
   last_modified_datetime VARCHAR2(14),
   user_field230        VARCHAR2(10),
   user_field231        VARCHAR2(2),
   surname              VARCHAR2(20),
   user_field232        VARCHAR2(14),
   user_field233        VARCHAR2(3),
...
(
   ...
   trans_time           VARCHAR2(14),
   post_txn_type        CHAR(1),
   txn_code             CHAR(4),
   loan_flag            CHAR(1),
   trans_amt            NUMBER(15,2),
   post_amt             NUMBER(15,2),
   transfer_in_date     VARCHAR2(14),
   user_field235        CHAR(6),
   user_field236        VARCHAR2(27),
   txn_curr_cd          CHAR(3),
   post_curr_cd         CHAR(3),
   orig_trans_date      VARCHAR2(14),
   plan_nbr             CHAR(6),
   ref_nbr              VARCHAR2(23),
   txn_desc             VARCHAR2(80),
   txn_short_desc       VARCHAR2(80),
   user_field237        NUMBER(13)  ,
   posting_flag         CHAR(3),
   pre_posting_flag     CHAR(3),
   user_field238        NUMBER(15,2),
   orig_pmt_amt         NUMBER(15,2),
   user_field239        CHAR(9),
   user_field240        VARCHAR2(8) ,
   user_field241        VARCHAR2(15),
   user_field242        VARCHAR2(15),
   mcc                  CHAR(4),
   input_txn_code       CHAR(4),
   input_txn_amt        NUMBER(15,2),
   input_sett_amt       NUMBER(15,2),
   user_field246        NUMBER(15,2),
   stmt_date            VARCHAR2(14),
   user_field247        VARCHAR2(7),
   jpa_version          INTEGER,
   term                 INTEGER,
   busi_serial          VARCHAR2(32),
   sys_trans_id         VARCHAR2(32),
   user_field248        VARCHAR2(15),
   sub_terminal_type    VARCHAR2(15),
   last_modified_datetime VARCHAR2(14),
   paid_stmt_date       VARCHAR2(14),
   repay_amt            NUMBER(15,2),
   bank_proportion      NUMBER(5,2),
   is_check_flag        CHAR(1),
   extend_param1        VARCHAR2(100),
   extend_param2        VARCHAR2(250),
...
(
   ...
   txn_desc             VARCHAR2(80),
   txn_short_desc       VARCHAR2(80),
   user_field254        NUMBER(13),
   posting_flag         CHAR(3),
   pre_posting_flag     CHAR(3),
   user_field255        NUMBER(15,2),
   orig_pmt_amt         NUMBER(15,2),
   user_field256        CHAR(9),
   user_field257        VARCHAR2(8) ,
   user_field258        VARCHAR2(15),
   user_field259        VARCHAR2(40),
   mcc                  CHAR(4),
   input_txn_code       CHAR(4),
   input_txn_amt        NUMBER(15,2),
   input_sett_amt       NUMBER(15,2),
   user_field260        NUMBER(15,2),
   user_field261        NUMBER(15,2),
   user_field262        NUMBER(15,2),
   user_field263        NUMBER(15,2),
   stmt_date            VARCHAR2(14),
   voucher_no           VARCHAR2(7),
   jpa_version          INTEGER,
   term                 INTEGER,
   busi_serial          VARCHAR2(32),
   sys_trans_id         VARCHAR2(32),
   user_field265        VARCHAR2(40),
   user_field264        VARCHAR2(15),
   sub_terminal_type    VARCHAR2(15),
   user_field266        VARCHAR2(60),
   user_field267        VARCHAR2(60),
   last_modified_datetime VARCHAR2(14),
   paid_stmt_date       VARCHAR2(14),
   repay_amt            NUMBER(15,2),
   bank_proportion      NUMBER(5,2),
...
(
   ...
   curr_term            INTEGER,
   remain_term          INTEGER,
   loan_init_prin       NUMBER(15,2),
   loan_fixed_pmt_prin  NUMBER(15,2),
   loan_first_term_prin NUMBER(15,2),
   loan_final_term_prin NUMBER(15,2),
   loan_init_fee1       NUMBER(15,2),
   loan_fixed_fee1      NUMBER(15,2),
   loan_first_term_fee1 NUMBER(15,2),
   loan_final_term_fee1 NUMBER(15,2),
   unearned_prin        NUMBER(15,2),
   unearned_fee1        NUMBER(15,2),
   paid_out_date        VARCHAR2(14),
   terminate_date       VARCHAR2(14),
   terminate_reason_cd  CHAR(1),
   prin_paid            NUMBER(15,2),
   int_paid             NUMBER(15,2),
   fee_paid             NUMBER(15,2),
   loan_curr_bal        NUMBER(15,2),
   loan_bal_xfrout      NUMBER(15,2),
   loan_bal_xfrin       NUMBER(15,2),
   loan_bal_principal   NUMBER(15,2),
   loan_bal_interest    NUMBER(15,2),
   loan_bal_penalty     NUMBER(15,2),
   loan_prin_xfrout     NUMBER(15,2),
   loan_prin_xfrin      NUMBER(15,2),
   loan_fee1_xfrout     NUMBER(15,2),
   loan_fee1_xfrin      NUMBER(15,2),
   orig_txn_amt         NUMBER(15,2),
   orig_trans_date      VARCHAR2(14),
   orig_auth_code       CHAR(6),
   jpa_version          INTEGER,
   loan_code            VARCHAR2(4),
   register_id          VARCHAR2(20),
   resch_init_prin      NUMBER(15,2),
   resch_date           VARCHAR2(14),
   bef_resch_fixed_pmt_prin NUMBER(15,2),
   bef_resch_init_term  INTEGER,
   bef_resch_first_term_prin NUMBER(15,2),
   bef_resch_final_term_prin NUMBER(15,2),
   bef_resch_init_fee1  NUMBER(15,2),
   bef_resch_fixed_fee1 NUMBER(15,2),
   bef_resch_first_term_fee1 NUMBER(15,2),
   bef_resch_final_term_fee1 NUMBER(15,2),
   resch_first_term_fee1 NUMBER(15,2),
   loan_fee_method      CHAR(1),
   interest_rate        NUMBER(12,4),
   penalty_rate         NUMBER(12,4),
   compound_rate        NUMBER(12,4),
   float_rate           NUMBER(5,2),
   loan_receipt_nbr     VARCHAR2(20),
   loan_expire_date     VARCHAR2(14),
   loan_cd              VARCHAR2(2),
   payment_hist         VARCHAR2(24),
   ctd_payment_amt      NUMBER(15,2),
   past_resch_cnt       INTEGER,
   past_shorted_cnt     INTEGER,
   adv_pmt_amt          NUMBER(15,2),
   last_action_date     VARCHAR2(14),
   last_action_type     CHAR(1),
   last_modified_datetime VARCHAR2(14),
   activate_date        VARCHAR2(14),
   interest_calc_base   VARCHAR2(14),
   first_bill_date      VARCHAR2(14),
   age_cd               CHAR(1),
   recalc_ind           CHAR(1),
   recalc_date          VARCHAR2(14),
   grace_date           VARCHAR2(14),
   cancel_date          VARCHAR2(14),
   cancel_reason        VARCHAR2(100),
   bank_group_id        VARCHAR2(5),
   due_days             INTEGER,
   contract_ver         VARCHAR2(200),
   loan_init_interest   NUMBER(15,2),
   bef_init_interest    NUMBER(15,2),
   bank_proportion      NUMBER(5,2),
   is_check_flag        CHAR(1),
   extend_param1        VARCHAR2(100),
   extend_param2        VARCHAR2(250),
...
(
   ...
   loan_init_term       INTEGER,
   curr_term            INTEGER,
   loan_term_prin       NUMBER(15,2),
   loan_term_fee1       NUMBER(15,2),
   loan_term_interest   NUMBER(15,2),
   loan_pmt_due_date    VARCHAR2(14),
   loan_grace_date      VARCHAR2(14),
   last_modified_datetime VARCHAR2(14),
   start_date           VARCHAR2(14),
   schedule_action      CHAR(1),
   prin_paid            NUMBER(15,2),
   int_paid             NUMBER(15,2),
   penalty_paid         NUMBER(15,2),
   compound_paid        NUMBER(15,2),
   fee_paid             NUMBER(15,2),
   is_check_flag        CHAR(1),
   extend_param1        VARCHAR2(100),
   extend_param2        VARCHAR2(250),
...
(
   ...
   ref_nbr              VARCHAR2(25),
   age_group            VARCHAR2(5),
   plan_nbr             VARCHAR2(10),
   bnp_group            VARCHAR2(5),
   bank_group_id        VARCHAR2(10),
   bank_no              VARCHAR2(15),
   term                 INTEGER,
   batchDate            VARCHAR2(14),
   is_check_flag        CHAR(1),
   extend_param1        VARCHAR2(100),
   extend_param2        VARCHAR2(250),
   extend_param3        VARCHAR2(40),
...
(
   ...
   org                  CHAR(12),
   cust_limit_id        VARCHAR2(20),
   limit_category       VARCHAR2(20),
   limit_type           CHAR(1),
   credit_limit         NUMBER(13,0),
   jpa_version          INTEGER,
   last_modified_datetime VARCHAR2(14),
   created_datetime     VARCHAR2(14),
   is_check_flag        CHAR(1),
...
(
   ...
   acq_name_addr        VARCHAR2(40),
   chb_txn_amt          NUMBER(15,2),
   chb_curr_cd          CHAR(3),
   user_field270        VARCHAR2(15),
   mcc                  CHAR(4),
   acq_branch_id        CHAR(9),
   fwd_inst_id          VARCHAR2(11),
   transmission_timestamp VARCHAR2(10),
   settle_date          CHAR(4),
   txn_direction        VARCHAR2(20),
   txn_terminal         VARCHAR2(40),
   trans_status         CHAR(1),
   trans_type           VARCHAR2(20),
   log_ol_time          VARCHAR2(14),
   log_biz_date         VARCHAR2(14),
   mti                  CHAR(4),
   orig_txn_type        VARCHAR2(20),
   orig_fwd_inst_id     VARCHAR2(11),
   orig_acq_inst_id     VARCHAR2(11),
   orig_mti             VARCHAR2(4),
   orig_trans_date      VARCHAR2(14),
   orig_trace_no        INTEGER,
   orig_txn_proc        CHAR(6),
   orig_txn_amt         NUMBER(15,2),
   orig_log_kv          VARCHAR2(20),
   orig_txn_val_1       VARCHAR2(38),
   orig_txn_val_2       VARCHAR2(40),
   orig_chb_txn_amt     NUMBER(15,2),
   orig_biz_date        VARCHAR2(14),
   last_reversal_date   VARCHAR2(14),
   void_count           INTEGER,
   manual_auth_flag     CHAR(1),
   opera_id             VARCHAR2(40),
   brand                VARCHAR2(2),
   product_code         CHAR(6),
   mcc_type             CHAR(2),
   user_field271        CHAR(4),
   user_field272        CHAR(1),
   comp_amt             NUMBER(15,2),
   final_upd_direction  CHAR(1),
   final_upd_amt        NUMBER(15,2),
   ic_ind               CHAR(1),
   ...
   otb                  NUMBER(15,2),
   cash_otb             NUMBER(15,2),
   cust_otb             NUMBER(15,2),
   user_field273        VARCHAR2(20),
   user_field274        VARCHAR2(20),
   expire_date          VARCHAR2(4),
   track_one_result     VARCHAR2(20),
   track_two_result     VARCHAR2(20),
   track_three_result   VARCHAR2(20),
   pwd_type             CHAR(1),
   check_pwd_result     VARCHAR2(20),
   pay_pwd_err_num      INTEGER,
   check_cvv_result     VARCHAR2(20),
   check_cvv2_result    VARCHAR2(20),
   check_icvn_result    VARCHAR2(20),
   check_arqc_result    VARCHAR2(20),
   check_atc_result     VARCHAR2(20),
   check_cvr_result     VARCHAR2(20),
   check_tvr_result     VARCHAR2(20),
   user_field275        VARCHAR2(40),
   unmatch_cr           NUMBER(15,2),
   unmatch_db           NUMBER(15,2),
   b002                 VARCHAR2(20),
   b003                 VARCHAR2(6),
   ...
   b039                 VARCHAR2(2),
   b042                 VARCHAR2(15),
   user_field277        VARCHAR2(103),
   user_field278        VARCHAR2(400),
   b090                 VARCHAR2(42),
   opera_term_id        VARCHAR2(20),
   jpa_version          INTEGER,
   b004                 NUMBER(13),
   b006                 NUMBER(13),
   b049                 CHAR(3),
   ...
   b048                 VARCHAR2(999),
   b054                 VARCHAR2(60),
   user_field279        VARCHAR2(27),
   user_field280        VARCHAR2(27),
   user_field281        VARCHAR2(27),
   busi_serial          VARCHAR2(32),
   sys_trans_id         VARCHAR2(32),
   user_field282        VARCHAR2(15),
   sub_terminal_type    VARCHAR2(15),
   sub_merch_id         VARCHAR2(40),
   sub_merch_name       VARCHAR2(60),
   wares_desc           VARCHAR2(60),
...
(
   ...
   acct_no              VARCHAR2(20),
   app_type             VARCHAR2(3),
   app_acct_no          VARCHAR2(40),
   user_field282        VARCHAR2(255),
   created_datetime     VARCHAR2(14),
   update_time          VARCHAR2(14),
   jpa_version          INTEGER,
   last_update_biz_date VARCHAR2(14),
   is_check_flag        CHAR(1),
   extend_param1        VARCHAR2(100),
   extend_param2        VARCHAR2(250),
   extend_param3        VARCHAR2(40),
...
(
   ...
   app_no               VARCHAR2(20),
   id_type              CHAR(1),
   certi_no             VARCHAR2(18),
   name                 VARCHAR2(90),
   gender               CHAR(1),
   birth_date           VARCHAR2(14),
   marital_status       VARCHAR2(2),
   mobile_no            VARCHAR2(20),
   home_phone           VARCHAR2(30),
   unit_phone           VARCHAR2(30),
   qualification        VARCHAR2(2),
   degree               VARCHAR2(2),
   address              VARCHAR2(700),
   reside_addr          VARCHAR2(700),
   mate_certp           CHAR(1),
   mate_cerno           VARCHAR2(18),
   mate_name            VARCHAR2(30),
   mate_corp            VARCHAR2(500),
   mate_phone           VARCHAR2(30),
   addr                 VARCHAR2(700),
   reside_state         VARCHAR2(2),
   comp_nm              VARCHAR2(700),
   unit_addr            VARCHAR2(700),
   profession           VARCHAR2(2),
   comp_trade           VARCHAR2(2),
   position             VARCHAR2(2),
   teach_pose           VARCHAR2(2),
   work_date            VARCHAR2(4),
   infodate             VARCHAR2(14),
...
(
   ...
   data_dt              VARCHAR2(10),
   acct_no              VARCHAR2(40),
   currency             VARCHAR2(23),
   acct_name            VARCHAR2(100),
   last_balance         NUMBER(20,4),
   balance              NUMBER(20,4),
   payment_amt          NUMBER(20,4),
   repayment_amt        NUMBER(20,4),
   other_credit_amt     NUMBER(20,4),
   other_debit_amt      NUMBER(20,4),
   ds                   VARCHAR2(10),
   is_check_flag        CHAR(1),
   extend_param1        VARCHAR2(100),
   extend_param2        VARCHAR2(250),
...
(
   ...
   case_no              VARCHAR2(32),
   cust_id              VARCHAR2(20),
   coll_rec_type        VARCHAR2(10),
   action_code          VARCHAR2(32),
   user_field1          CHAR(1),
   user_field2          VARCHAR2(4),
   coll_time            VARCHAR2(14),
   coll_conseq          VARCHAR2(10),
   prom_amt             NUMBER(15,2),
   prom_date            VARCHAR2(14),
   user_field3          VARCHAR2(400),
   user_field4          NUMBER(15,2),
   user_field5          VARCHAR2(10),
   user_field6          VARCHAR2(10),
   user_field7          VARCHAR2(10),
   user_field8          VARCHAR2(10),
   user_field9          VARCHAR2(10),
   user_field10         VARCHAR2(10),
   user_field11         VARCHAR2(20),
   user_field12         VARCHAR2(50),
   user_field13         VARCHAR2(50),
   user_field14         VARCHAR2(10),
   user_field15         VARCHAR2(10),
   user_field16         VARCHAR2(50),
   user_field17         VARCHAR2(50),
   user_field18         VARCHAR2(14),
   user_field19         VARCHAR2(14),
...
(
   ...
   bank_no              VARCHAR2(10),
   product_cd           VARCHAR2(6),
   biz_tax_interes      NUMBER(15,2),
   vat_int_bal          NUMBER(15,2),
   norevoke_vat_int_bal NUMBER(15,2),
   vat_tax              NUMBER(15,2),
   loan_int_term        INTEGER,
   last_modified_time   VARCHAR2(14),
   paid_out_date        VARCHAR2(14),
   age_no               CHAR(1),
   batch_date           VARCHAR2(14),
   lpa_version          INTEGER,
   is_check_flag        CHAR(1),
   extend_param1        VARCHAR2(100),
   extend_param2        VARCHAR2(250),
...
(
   ...
   bank_group_id        VARCHAR2(5),
   bank_no              VARCHAR2(10),
   busi_serial          VARCHAR2(40),
   trans_type           VARCHAR2(10),
   name                 VARCHAR2(80),
   logical_card_no      VARCHAR2(19),
   bf_amt               NUMBER(15,2),
   account_amt          NUMBER(15,2),
   error_amt            NUMBER(15,2),
   is_check_flag        CHAR(1),
   extend_param1        VARCHAR2(100),
   extend_param2        VARCHAR2(250),
   extend_param3        VARCHAR2(40),
...
(
   ...
   file_order           INTEGER              not null,
   out_amt              NUMBER(15,2),
   out_prin             NUMBER(15,2),
   out_interest         NUMBER(15,2),
   out_penatly          NUMBER(15,2),
   out_due_days         INTEGER,
   out_age_cd           CHAR(6),
   repay_amt            NUMBER(15,2),
   commision_ratio      NUMBER(7,2),
   bank_group_id        VARCHAR2(5),
   bank_proportion      NUMBER(7,2),
   out_expense          NUMBER(15,2),
   name                 VARCHAR2(80),
   logical_card_no      VARCHAR2(19),
   cust_id              VARCHAR2(20),
   acct_no              VARCHAR2(20),
...
(
   ...
   loan_init_prin       NUMBER(15,2),
   bank_group_id        VARCHAR2(5),
   writeoff_proc_status VARCHAR2(20),
   writeoff_proc_desc   VARCHAR2(100),
   product_attr         VARCHAR2(5),
   name                 VARCHAR2(200),
   writeoff_date        VARCHAR2(10),
   bank_no              VARCHAR2(20),
   bank_proportion      NUMBER(5,2),
   is_check_flag        CHAR(1),
   extend_param1        VARCHAR2(100),
...
/*==============================================================*/
/* Table: ICPS_WB_DS_APPROVAL_FLOW                              */
/*==============================================================*/
create table ICPS_WB_DS_APPROVAL_FLOW 
(
   busi_date            CHAR(8)              not null,
   file_order           INTEGER              not null,
   partition_date       VARCHAR2(10),
   busi_no              VARCHAR2(40),
   bank_no              VARCHAR2(20),
   final_ret            VARCHAR2(20),
   ours_approval_ret    VARCHAR2(40),
   code_block           VARCHAR2(200),
   is_first             VARCHAR2(2),
   outer_ret            VARCHAR2(40),
   psz_ret              VARCHAR2(40),
   is_check_flag        CHAR(1),
   extend_param1        VARCHAR2(100),
   extend_param2        VARCHAR2(250),
   extend_param3        VARCHAR2(40),
   constraint PK_ICPS_WB_DS_APPROVAL_FLOW primary key (busi_date, file_order)
);

comment on table ICPS_WB_DS_APPROVAL_FLOW is
'审批结果流水表';

comment on column ICPS_WB_DS_APPROVAL_FLOW.busi_date is
'业务日期';

comment on column ICPS_WB_DS_APPROVAL_FLOW.file_order is
'文件序号';

comment on column ICPS_WB_DS_APPROVAL_FLOW.partition_date is
'分区日期';

comment on column ICPS_WB_DS_APPROVAL_FLOW.busi_no is
'流水号';

comment on column ICPS_WB_DS_APPROVAL_FLOW.bank_no is
'银行号';

comment on column ICPS_WB_DS_APPROVAL_FLOW.final_ret is
'最终审批结果';

comment on column ICPS_WB_DS_APPROVAL_FLOW.ours_approval_ret is
'合作行审批结果';

comment on column ICPS_WB_DS_APPROVAL_FLOW.code_block is
'拒绝码';

comment on column ICPS_WB_DS_APPROVAL_FLOW.is_first is
'是否首借';

comment on column ICPS_WB_DS_APPROVAL_FLOW.outer_ret is
'合作行机房审批结果';

comment on column ICPS_WB_DS_APPROVAL_FLOW.psz_ret is
'Psz区审批结果';

comment on column ICPS_WB_DS_APPROVAL_FLOW.is_check_flag is
'参与对账标识';

comment on column ICPS_WB_DS_APPROVAL_FLOW.extend_param1 is
'扩展1';

comment on column ICPS_WB_DS_APPROVAL_FLOW.extend_param2 is
'扩展2';

comment on column ICPS_WB_DS_APPROVAL_FLOW.extend_param3 is
'扩展3';