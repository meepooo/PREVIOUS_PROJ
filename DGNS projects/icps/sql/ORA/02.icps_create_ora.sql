...
/* Created on:     2017/6/13 8:50:18                            */
/*==============================================================*/

drop table ICPS_SERIAL cascade constraints;

drop table ICPS_APPLY cascade constraints;

drop table ICPS_PEOPLE_BANK_CREDIT cascade constraints;

drop table ICPS_SESAME_CRED cascade constraints;

drop table ICPS_BANK_CREDIT cascade constraints;

drop table ICPS_BUSI_INF cascade constraints;

drop table ICPS_TOTAL cascade constraints;

drop table ICPS_LENDING_DETAIL cascade constraints;

drop table ICPS_LOAN_DETAIL cascade constraints;

drop table ICPS_REPAY_PLAN cascade constraints;

drop table ICPS_REPAY_LOAN_DETAIL cascade constraints;

drop table ICPS_REPAY_INSTMNT_DETAIL cascade constraints;

drop table ICPS_XPT_LOAN_DETAIL cascade constraints;

drop table ICPS_XPT_INSTMNT_DETAIL cascade constraints;

drop table ICPS_LOAN_INIT cascade constraints;

drop table ICPS_INSTMNT_INIT cascade constraints;

drop table ICPS_LOAN_CALC cascade constraints;

drop table ICPS_ARG_STATUS_CHANGE cascade constraints;

drop table ICPS_FUND_DETAIL cascade constraints;
...
(
   ...
   plt_serial           VARCHAR2(16)         not null,
   busi_date            VARCHAR2(8)          not null,
   busi_no              VARCHAR2(16)         not null,
   channel              VARCHAR2(16),
   local_id             VARCHAR2(32),
   trans_code           VARCHAR2(8),
   send_recv_flag       CHAR(1),
   apply_no             VARCHAR2(64),
   version              VARCHAR2(8),
   send_time_zone       VARCHAR2(32),
   send_dttm            VARCHAR2(16),
   msg_id               VARCHAR2(64),
   third_id             VARCHAR2(32),
   third_trans_code     VARCHAR2(64),
   third_respcode       VARCHAR2(16),
   third_respmsg        VARCHAR2(255),
   third_trans_status   VARCHAR2(1),
   retry                CHAR(1),
   send_host_serial     VARCHAR2(64),
   send_host_date       CHAR(8),
   host_serial          VARCHAR2(64),
   host_date            CHAR(8),
   host_trans_code      VARCHAR2(16),
   host_respcode        VARCHAR2(16),
   host_respmsg         VARCHAR2(250),
   host_status          VARCHAR2(2),
   respcode             VARCHAR2(8),
   respmsg              VARCHAR2(250),
   trans_status         VARCHAR2(1),
   branch               VARCHAR2(16),
   teller               VARCHAR2(16),
   grant_branch         VARCHAR2(16),
   grant_teller         VARCHAR2(16),
   extend_param1        VARCHAR2(10),
   extend_param2        VARCHAR2(250),
   extend_param3        VARCHAR2(40),
   extend_param4        VARCHAR2(60),
   extend_param5        VARCHAR2(250),
...
(
   busi_no              VARCHAR2(16)         not null,
   apply_no             VARCHAR2(64)         not null,
   id_type              VARCHAR2(2)          not null,
   id_num               VARCHAR2(32)         not null,
   id_valid_end_date    VARCHAR2(8),
   name                 VARCHAR2(64)         not null,
   mobile_no            VARCHAR2(32)         not null,
   auth_flag            CHAR(1),
   has_admit_flag       CHAR(1),
   apply_plt_date       CHAR(8),
   apply_plt_serial     VARCHAR2(16),
   apply_status         CHAR(1),
   credit_no            VARCHAR2(32),
   info_admit_flag      CHAR(1),
   credit_amt           NUMERIC(16,2),
   credit_rate          NUMERIC(16,6),
   refuse_code          VARCHAR2(64),
   refuse_reason        VARCHAR2(1024),
   info_plt_date        CHAR(8),
   info_plt_serial      VARCHAR2(16),
   info_status          CHAR(1),
   third_access         CHAR(1),
   third_refuse_reason  VARCHAR2(1024),
   third_amt            NUMERIC(16,2),
   third_rate           NUMERIC(16,6),
   risk_rating          CHAR(1),
   solvency_rating      CHAR(1),
   change_result_reason VARCHAR2(1024),
   ack_admit_flag       CHAR(1),
   ack_admit_msg        VARCHAR2(255),
   ack_plt_date         CHAR(8),
   ack_plt_serial       VARCHAR2(16),
   ack_status           CHAR(1),
...
(
   ...
   loan_max_amount      NUMERIC(16,2),
   loan_oper_max_amount NUMERIC(16,2),
   balance_sum          NUMERIC(16,2),
   loan_sum_amount      NUMERIC(16,2),
   ln_nca_amt_avg       NUMERIC(16,2),
   loan_house_amt_sum   NUMERIC(16,2),
   loan_house_bal_sum   NUMERIC(16,2),
   business_loan_sum_amount NUMERIC(16,2),
   business_loan_sum_balance NUMERIC(16,2),
   ln_nca_con13_bal_sum NUMERIC(16,2),
   ln_nca_rmm_avg       INTEGER,
   ln_nca_pmm_avg       INTEGER,
   ln_nca_pmo_avg       NUMERIC(16,2),
   ln_nca_pmt_sum       NUMERIC(16,2),
   repay_car_mon        NUMERIC(16,2),
   repay_house_mon      NUMERIC(16,2),
   ln_nca_m1_max_3m     INTEGER,
   loan_ovd_max_bal_cpt NUMERIC(16,2),
   loan_cur_ovd_amount  NUMERIC(16,2),
   ...
   dull_loan_sum        NUMERIC(16,2),
   all_assure_loan_num  INTEGER,
   all_assure_loan_sum  NUMERIC(16,2),
   cont_under_attention_assure INTEGER,
   cont_under_secondary_assure NUMERIC(16,2),
   assure_under_attention_amt NUMERIC(16,2),
   as_cv2_bal_sum       NUMERIC(16,2),
   card_amt_sum         NUMERIC(16,2),
   cc_act_lmt_max       NUMERIC(16,2),
   ac_nml_lmt_avg       NUMERIC(16,2),
   ac_nml_lmt_sum       NUMERIC(16,2),
   ...
   cc_act_cu_o90_pct    NUMERIC(16,5),
   cc_nca_cu_min        NUMERIC(16,5),
   cc_nca_mu_max        NUMERIC(16,5),
   card_nca_hb_max      NUMERIC(16,2),
   ac_nca_cu_avg        NUMERIC(16,5),
   ac_nca_hb_max        NUMERIC(16,2),
   cc_nml_mu_avg        NUMERIC(16,5),
   all_card_cur_ovd_used NUMERIC(16,5),
   card_nca_pmo_sum     NUMERIC(16,2),
   card_delq_6mth_max_cnt INTEGER,
   card_delq_12mth_max_cnt INTEGER,
   card_delq_3mth_max_cnt INTEGER,
   card_max_ovd_bal     NUMERIC(16,2),
   all_card_cur_ovd_amt_sum NUMERIC(16,2),
   cont_dull_card_cnt   INTEGER,
   dull_scard_cnt       INTEGER,
   ac_abn_cnt_sum       INTEGER,
   cc_act_m1_cnt_3m     INTEGER,
   cc_act_m1_cnt_pct_3m NUMERIC(16,5),
   cc_act_m1_cnt_pct_6m NUMERIC(16,5),
...
(
   ...
   ovd_order_amt_6m     NUMERIC(16,2),
   mobile_fixed_days    INTEGER,
   adr_stability_days   INTEGER,
   last_6m_avg_asset_total NUMERIC(16,2),
   tot_pay_amt_6m       NUMERIC(16,2),
   xfdc_index           VARCHAR2(64),
...
(
   ...
   avg_balance_last_3days NUMERIC(16,2),
   avg_balance_last_6days NUMERIC(16,2),
   income_last_3m       NUMERIC(16,2),
   pay_last_3m          NUMERIC(16,2),
   income_last_6m       NUMERIC(16,2),
   pay_last_6m          NUMERIC(16,2),
   is_exist_credit_customer CHAR(1),
   curr_credit_card_amt NUMERIC(16,2),
   curr_use_credit_card_amt NUMERIC(16,2),
   is_exist_fin_customer CHAR(1),
   fin_balance          NUMERIC(16,2),
   avg_fin_bal_last_6m  NUMERIC(16,2),
   is_exist_insurance_customer CHAR(1),
   is_exist_loan_customer CHAR(1),
   operation_loan_bal   NUMERIC(16,2),
   personal_credit_bal  NUMERIC(16,2),
   car_loan_bal         NUMERIC(16,2),
   car_asset            NUMERIC(16,2),
   house_loan_bal       NUMERIC(16,2),
   house_asset          NUMERIC(16,2),
...
(
   busi_no              VARCHAR2(16)         not null,
   busi_nm              VARCHAR2(64),
   local_id             VARCHAR2(16),
   time_zone            VARCHAR2(32),
   sign_type            VARCHAR2(16),
   message_charset      VARCHAR2(16),
   version              VARCHAR2(8),
   clear_acct_id        VARCHAR2(64),
   clear_acct_nm        VARCHAR2(128),
   position_acct_id     VARCHAR2(64),
   position_acct_nm     VARCHAR2(128),
   fee_out_acct_id      VARCHAR2(64),
   fee_out_acct_nm      VARCHAR2(128),
   fee_in_acct_id       VARCHAR2(64),
   fee_in_acct_nm       VARCHAR2(128),
   provisions_acct_id   VARCHAR2(64),
   provisions_acct_nm   VARCHAR2(128),
   open_flag            CHAR(1),
   extend_param1        VARCHAR2(100),
   extend_param2        VARCHAR2(250),
   extend_param3        VARCHAR2(40)
...
(
   ...
   encash_amt           NUMERIC(16,2),
   withhold_amt         NUMERIC(16,2),
   refund_amt           NUMERIC(16,2),
   accrued_int_amt      NUMERIC(16,2),
   non_accrued_int_amt  NUMERIC(16,2),
   accrued_ovd_prin_pnlt_amt NUMERIC(16,2),
   non_accrued_ovd_prin_pnlt_amt NUMERIC(16,2),
   accrued_ovd_int_pnlt_amt NUMERIC(16,2),
   non_accrued_ovd_int_pnlt_amt NUMERIC(16,2),
   prin_to_ovd_prin_amt NUMERIC(16,2),
   int_to_ovd_int_amt   NUMERIC(16,2),
   accrued_to_non_prin_amt NUMERIC(16,2),
   accrued_to_non_ovd_prin_amt NUMERIC(16,2),
   in_to_out_int_amt    NUMERIC(16,2),
   in_to_out_ovd_int_amt NUMERIC(16,2),
   in_to_out_ovd_prin_pnlt_amt NUMERIC(16,2),
   in_to_out_ovd_int_pnlt_amt NUMERIC(16,2),
   non_to_accrued_prin_amt NUMERIC(16,2),
   non_to_accrued_ovd_prin_amt NUMERIC(16,2),
   out_to_in_int_amt    NUMERIC(16,2),
   out_to_in_ovd_int_amt NUMERIC(16,2),
   out_to_in_ovd_prin_pnlt_amt NUMERIC(16,2),
   out_to_in_ovd_int_pnlt_amt NUMERIC(16,2),
   paid_prin_amt        NUMERIC(16,2),
   paid_non_accrued_prin_amt NUMERIC(16,2),
   paid_accrued_ovd_prin_amt NUMERIC(16,2),
   paid_non_accrued_ovd_prin_amt NUMERIC(16,2),
   paid_int_amt         NUMERIC(16,2),
   paid_out_int_amt     NUMERIC(16,2),
   paid_in_ovd_int_amt  NUMERIC(16,2),
   paid_out_ovd_int_amt NUMERIC(16,2),
   paid_in_ovd_prin_pnlt_int_amt NUMERIC(16,2),
   paid_out_ovd_prin_pnlt_int_amt NUMERIC(16,2),
   paid_in_ovd_int_pnlt_int_amt NUMERIC(16,2),
   paid_out_ovd_int_pnlt_int_amt NUMERIC(16,2),
   xpt_in_int_amt       NUMERIC(16,2),
   xpt_out_int_amt      NUMERIC(16,2),
   xpt_in_ovd_int_amt   NUMERIC(16,2),
   xpt_out_ovd_int_amt  NUMERIC(16,2),
   xpt_in_ovd_prin_pnlt_int_amt NUMERIC(16,2),
   xpt_out_ovd_prin_pnlt_int_amt NUMERIC(16,2),
   xpt_in_ovd_int_pnlt_int_amt NUMERIC(16,2),
   xpt_out_ovd_int_pnlt_int_amt NUMERIC(16,2),
   extend_param1        VARCHAR2(100),
   extend_param2        VARCHAR2(250),
   extend_param3        VARCHAR2(40),
...
(
   ...
   fund_seq_no          VARCHAR2(64),
   third_product_code   VARCHAR2(64),
   name                 VARCHAR2(128),
   id_type              VARCHAR2(2),
   id_num               VARCHAR2(32),
   ...
   encash_date          VARCHAR2(20),
   currency             VARCHAR2(3),
   encash_amt           NUMERIC(16,2),
   start_date           VARCHAR2(8),
   end_date             VARCHAR2(8),
   total_terms          INTEGER,
   repay_mode           VARCHAR2(8),
   grace_day            INTEGER,
   rate_type            VARCHAR2(2),
   day_rate             NUMERIC(16,6),
   prin_repay_frequency VARCHAR2(2),
   int_repay_frequency  VARCHAR2(2),
   guarantee_type       VARCHAR2(3),
   credit_no            VARCHAR2(64),
   encash_acct_type     VARCHAR2(2),
   encash_acct          VARCHAR2(32),
   repay_acct_type      VARCHAR2(2),
   repay_acct           VARCHAR2(32),
...
(
   ...
   start_date           VARCHAR2(8),
   end_date             VARCHAR2(8),
   prin_amt             NUMERIC(16,2),
   int_amt              NUMERIC(16,2),
   is_check_flag        CHAR(1),
   extend_param1        VARCHAR2(100),
   extend_param2        VARCHAR2(250),
   extend_param3        VARCHAR2(40),
...
(
   ...
   repay_seq_no         VARCHAR2(64),
   fee_no               VARCHAR2(64),
   withdraw_no          VARCHAR2(64),
   repay_type           VARCHAR2(8),
   repay_date           VARCHAR2(20),
   curr_prin_bal        NUMERIC(16,2),
   curr_ovd_prin_bal    NUMERIC(16,2),
   curr_int_bal         NUMERIC(16,2),
   curr_ovd_int_bal     NUMERIC(16,2),
   curr_ovd_prin_pnlt_bal NUMERIC(16,2),
   curr_ovd_int_pnlt_bal NUMERIC(16,2),
   repay_amt            NUMERIC(16,2),
   paid_prin_amt        NUMERIC(16,2),
   paid_ovd_prin_amt    NUMERIC(16,2),
   paid_int_amt         NUMERIC(16,2),
   paid_ovd_int_amt     NUMERIC(16,2),
   paid_ovd_prin_pnlt_amt NUMERIC(16,2),
   paid_ovd_int_pnlt_amt NUMERIC(16,2),
   fee_amt              NUMERIC(16,2),
   is_check_flag        CHAR(1),
   extend_param1        VARCHAR2(100),
   extend_param2        VARCHAR2(250),
   extend_param3        VARCHAR2(40),
...
(
   ...
   file_order           INTEGER              not null,
   contract_no          VARCHAR2(32),
   xpt_seq_no           VARCHAR2(64),
   xpt_date             VARCHAR2(20),
   curr_int_bal         NUMERIC(16,2),
   curr_ovd_int_bal     NUMERIC(16,2),
   curr_ovd_prin_pnlt_bal NUMERIC(16,2),
   curr_ovd_int_pnlt_bal NUMERIC(16,2),
   xpt_amt              NUMERIC(16,2),
   xpt_int_amt          NUMERIC(16,2),
   xpt_ovd_int_amt      NUMERIC(16,2),
   xpt_ovd_prin_pnlt_amt NUMERIC(16,2),
   xpt_ovd_int_pnlt_amt NUMERIC(16,2),
   is_check_flag        CHAR(1),
   extend_param1        VARCHAR2(100),
   extend_param2        VARCHAR2(250),
   extend_param3        VARCHAR2(40),
...
(
   ...
   accrued_status       VARCHAR2(2),
   next_repay_date      VARCHAR2(8),
   unclear_terms        INTEGER,
   ovd_terms            INTEGER,
   prin_ovd_days        INTEGER,
   int_ovd_days         INTEGER,
   prin_bal             NUMERIC(16,2),
   ovd_prin_bal         NUMERIC(16,2),
   int_bal              NUMERIC(16,2),
   ovd_int_bal          NUMERIC(16,2),
   ovd_prin_pnlt_bal    NUMERIC(16,2),
   ovd_int_pnlt_bal     NUMERIC(16,2),
   is_check_flag        CHAR(1),
   extend_param1        VARCHAR2(100),
   extend_param2        VARCHAR2(250),
   extend_param3        VARCHAR2(40),
...
(
   ...
   status               VARCHAR2(10),
   clear_date           VARCHAR2(8),
   prin_ovd_date        VARCHAR2(8),
   int_ovd_date         VARCHAR2(8),
   prin_ovd_days        INTEGER,
   int_ovd_days         INTEGER,
   prin_bal             NUMERIC(16,2),
   int_bal              NUMERIC(16,2),
...
(
   ...
   ovd_prin_bal         NUMERIC(16,2),
   ovd_int_bal          NUMERIC(16,2),
   real_rate            NUMERIC(16,6),
   pnlt_rate            NUMERIC(16,6),
   int_amt              NUMERIC(16,2),
   ovd_prin_pnlt_amt    NUMERIC(16,2),
   ovd_int_pnlt_amt     NUMERIC(16,2),
   is_check_flag        CHAR(1),
   extend_param1        VARCHAR2(100),
   extend_param2        VARCHAR2(250),
   extend_param3        VARCHAR2(40),
...
(
   ...
   contract_no          VARCHAR2(32),
   settle_date          VARCHAR2(8),
   status_seq_no        VARCHAR2(64),
   event_code           VARCHAR2(16),
   before_status        VARCHAR2(10),
   after_status         VARCHAR2(10),
   prin_amt             NUMERIC(16,2),
   int_amt              NUMERIC(16,2),
   ovd_prin_pnlt_amt    NUMERIC(16,2),
   ovd_int_pnlt_amt     NUMERIC(16,2),
...
(
   busi_date            CHAR(8)              not null,
   file_order           INTEGER              not null,
   third_busi_serial    VARCHAR2(64),
   third_busi_type      VARCHAR2(32),
   trans_amt            NUMERIC(16,2),
   trans_refund_amt     NUMERIC(16,2),
   trans_dttm           VARCHAR2(14),
   third_trans_name     VARCHAR2(256),
   peer_org_name        VARCHAR2(32),
   trans_sub_detail     VARCHAR2(128),
   is_check_flag        CHAR(1),
   extend_param1        VARCHAR2(100),
   extend_param2        VARCHAR2(250),
   extend_param3        VARCHAR2(40),
