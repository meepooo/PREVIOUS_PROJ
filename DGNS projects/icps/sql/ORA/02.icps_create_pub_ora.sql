...
drop table ICPS_DAILY_STATUS cascade constraints;

drop table ICPS_FILE_INFO cascade constraints;
...
(
   ...
   in_channel_date      VARCHAR2(64),
   in_channel_serial    VARCHAR2(8),
   respcode             VARCHAR2(8),
...
comment on column ICPS_DAILY_STATUS.clear_status is
...
comment on column ICPS_DAILY_STATUS.send_host_serial is
'上送主机流水号';
...
'文件状态 0 未入库 1 入库成功 2 入库失败 9 入库中';
