drop table ICPS_JT_LOAN_TOTAL cascade constraints;

drop table ICPS_JT_CUS cascade constraints;

drop table ICPS_JT_CUSCREDIT cascade constraints;

drop table ICPS_JT_QUOTAADJUST cascade constraints;

drop table ICPS_JT_LOAN cascade constraints;

drop table ICPS_JT_PLAN cascade constraints;

drop table ICPS_JT_FLOW cascade constraints;

drop table ICPS_JT_FUND_DETAIL cascade constraints;
...
(
   ...
   non_prin_to_ovd_prin_amt NUMERIC(16,2),
   accrued_to_non_ovd_prin_amt NUMERIC(16,2),
   in_int_to_ovd_int_amt NUMERIC(16,2),
   out_int_to_ovd_int_amt NUMERIC(16,2),
   in_to_out_ovd_int_amt NUMERIC(16,2),
   in_to_out_pnlt_int_amt NUMERIC(16,2),
   in_refund_ovd_int_amt NUMERIC(16,2),
   ...
   paid_in_pnlt_int_amt NUMERIC(16,2),
   paid_out_pnlt_int_amt NUMERIC(16,2),
   ahead_prin_amt       NUMERIC(16,2),
   ahead_int_amt        NUMERIC(16,2),
   refund_prin_amt      NUMERIC(16,2),
   refund_ovd_prin_amt  NUMERIC(16,2),
   refund_in_pnlt_int   NUMERIC(16,2),
   encash_amt2          NUMERIC(16,2),
   prin_to_ovd_prin_amt2 NUMERIC(16,2),
   non_prin_to_ovd_prin_amt2 NUMERIC(16,2),
   accrued_to_non_ovd_prin_amt2 NUMERIC(16,2),
   in_int_to_ovd_int_amt2 NUMERIC(16,2),
   out_int_to_ovd_int_amt2 NUMERIC(16,2),
   in_to_out_ovd_int_amt2 NUMERIC(16,2),
   in_to_out_pnlt_int_amt2 NUMERIC(16,2),
   in_refund_ovd_int_amt2 NUMERIC(16,2),
   paid_prin_amt2       NUMERIC(16,2),
   paid_accrued_ovd_prin_amt2 NUMERIC(16,2),
   paid_non_accrued_ovd_prin_amt2 NUMERIC(16,2),
   paid_int_amt2        NUMERIC(16,2),
   paid_in_ovd_int_amt2 NUMERIC(16,2),
   paid_out_ovd_int_amt2 NUMERIC(16,2),
   paid_in_pnlt_int_amt2 NUMERIC(16,2),
   paid_out_pnlt_int_amt2 NUMERIC(16,2),
   ahead_prin_amt2      NUMERIC(16,2),
   ahead_int_amt2       NUMERIC(16,2),
   refund_prin_amt2     NUMERIC(16,2),
   refund_ovd_prin_amt2 NUMERIC(16,2),
   refund_in_pnlt_int_amt2 NUMERIC(16,2),
...
(
   ...
   quota                NUMERIC(16,2),
   limit                INTEGER,
   nouse_quota          NUMERIC(16,2),
   tmp_quota_flag       VARCHAR2(4),
   auth_status          VARCHAR2(3),
   is_check_flag        CHAR(1),
   extend_param1        VARCHAR2(100),
   extend_param2        VARCHAR2(250),
   extend_param3        VARCHAR2(40),
...
(
   ...
   product_code         VARCHAR2(4),
   quota_code           VARCHAR2(60),
   adjust_type          VARCHAR2(2),
   adjust_mode          VARCHAR2(2),
   adjust_quota         NUMERIC(26,8),
   before_adjust_quota  NUMERIC(26,8),
   after_adjust_quota   NUMERIC(26,8),
   adjust_cal_date      VARCHAR2(8),
   adjust_effective_date VARCHAR2(8),
   adjust_serial        VARCHAR2(60),
   error_type           CHAR(1),
   is_check_flag        CHAR(1),
   extend_param1        VARCHAR2(100),
   extend_param2        VARCHAR2(250),
...
(
   ...
   product_code         VARCHAR2(4),
   quota_code           VARCHAR2(60),
   loan_code            VARCHAR2(60),
   currency             CHAR(3),
   loan_status          CHAR(1),
   encash_date          VARCHAR2(8),
   encash_amt           NUMERIC(16,8),
   end_date             VARCHAR2(8),
   use_area             VARCHAR2(6),
   prin_repay_frequency VARCHAR2(6),
   int_repay_frequency  VARCHAR2(6),
   self_pay_amt         NUMERIC(16,2),
   entrusted_pay_amt    NUMERIC(16,2),
   ovd_flag             CHAR(1),
   ovd_days             INTEGER,
   ovd_non_days         INTEGER,
   prin_ovd_days        VARCHAR2(8),
   int_ovd_days         VARCHAR2(8),
   next_int_date        VARCHAR2(8),
   rate_type            VARCHAR2(6),
   loan_bal             NUMERIC(16,2),
   ovd_loan_bal         NUMERIC(16,2),
   ovd_int              NUMERIC(16,2),
   out_int_bal          NUMERIC(16,2),
   int_flag             CHAR(1),
   accrued_int          NUMERIC(16,2),
   int_amt              NUMERIC(16,2),
   pnlt_amt             NUMERIC(16,2),
   encash_acct          VARCHAR2(64),
   repay_acct           VARCHAR2(64),
   guarantee_type       CHAR(3),
   repay_mode           CHAR(1),
   loan_rate            NUMERIC(16,8),
   penalty_rate         NUMERIC(16,8),
...
(
   ...
   term_no              VARCHAR2(20),
   repay_order          INTEGER,
   prin_end_date        VARCHAR2(10),
   prin_amt             NUMERIC(16,2),
   int_end_date         VARCHAR2(10),
   int_amt              NUMERIC(16,2),
   repay_terms          INTEGER,
   pnlt_amt             NUMERIC(16,2),
   is_check_flag        CHAR(1),
...
(
   ...
   repay_serial         VARCHAR2(40),
   repay_mode           VARCHAR2(6),
   curr_prin_amt        NUMERIC(16,2),
   prin_amt             NUMERIC(16,2),
   curr_int_amt         NUMERIC(16,2),
   int_amt              NUMERIC(16,2),
   curr_other_amt       NUMERIC(16,2),
   pnlt_amt             NUMERIC(16,2),
   repay_order          INTEGER,
   unclear_terms        INTEGER,
   repay_amt_type       VARCHAR2(6),
   is_check_flag        CHAR(1),
   extend_param1        VARCHAR2(100),
   extend_param2        VARCHAR2(250),
   extend_param3        VARCHAR2(40),
...
(
   ...
   summary_code         VARCHAR2(10),
   summary              VARCHAR2(250),
   acct_bal             NUMERIC(16,2),
   currency             CHAR(3),
   peer_acct            VARCHAR2(36),
   peer_acct_name       VARCHAR2(60),
