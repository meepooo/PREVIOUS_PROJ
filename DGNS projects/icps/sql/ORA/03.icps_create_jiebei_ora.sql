...
drop table ICPS_PBOC_CREDIT cascade constraints;

drop table ICPS_ZM_CREDIT cascade constraints;

drop table ICPS_BANK_CREDIT cascade constraints;

drop table ICPS_JB_TOTAL cascade constraints;

drop table ICPS_JB_LENDING_DETAIL cascade constraints;

drop table ICPS_JB_LOAN_DETAIL cascade constraints;

drop table ICPS_JB_REPAY_PLAN cascade constraints;

drop table ICPS_JB_REPAY_LOAN_DETAIL cascade constraints;

drop table ICPS_JB_REPAY_INSTMNT_DETAIL cascade constraints;

drop table ICPS_JB_XPT_LOAN_DETAIL cascade constraints;

drop table ICPS_JB_XPT_INSTMNT_DETAIL cascade constraints;

drop table ICPS_JB_LOAN_INIT cascade constraints;

drop table ICPS_JB_INSTMNT_INIT cascade constraints;

drop table ICPS_JB_LOAN_CALC cascade constraints;

drop table ICPS_JB_ARG_STATUS_CHANGE cascade constraints;

drop table ICPS_JB_FUND_DETAIL cascade constraints;
